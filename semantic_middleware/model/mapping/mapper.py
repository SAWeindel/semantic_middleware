...
if __name__ == "__main__":
    ...
    print(
        mapped_model, type(mapped_model)
    )  # <semantic_middleware.model.mapping.mapper.ExampleDataModel2 object at 0x7f8b3c3b3d30> <class 'semantic_middleware.model.mapping.mapper.ExampleDataModel2'>
